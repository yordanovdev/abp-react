...
declare const AbpWrapper: React.FC<IWrapperProps>;

declare const initialiseApp: (configurationResponse: any) => void;

declare const useAbp: () => typeof abp;
...
declare const useUser: () => IUser | null;
 ...
 */
declare const login: (result: ILogin) => ILogin;
/**
 * The function `clearAuthCookies` clears the authentication token and refresh token.
 */
declare const clearAuthCookies: () => void;

declare function L(key: string, sourceName: string): string;

export { AbpWrapper, L, abp, clearAuthCookies, initialiseApp, login, useAbp, useUser };
